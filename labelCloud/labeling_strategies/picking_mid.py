...
class PickingStrategy_mid(BaseLabelingStrategy):
    POINTS_NEEDED = 1
    PREVIEW = True
    ...
    def __init__(self, view: "GUI") -> None:
        ...
        self.copied_length: float = 0.5
        self.copied_width: float = 0.5
        self.copied_height: float = 0.5
    ...
    def draw_preview(self) -> None:  # TODO: Refactor
        if self.tmp_p1:
            ...
            new_row = {'index': ''
                       ...
                       ,'active': 'button_mid_bbox_preview'
                       ,'input': 'button_clicked'
                       ,'input_detail': 'button_mid_bbox'
                       ,'mouse_position_x': ''
                       ,'mouse_position_y': ''
                       ,'rot_x': ''
                       ,'rot_y': ''
    ...
    def get_bbox(self) -> BBox:  # TODO: Refactor
       ...
       #logging.info(f"get_bbox ({self.copied_length})")
        ...
        new_row = {'index': ''
                   ...
                   ,'pcd': ''
                   ,'time':datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')
                   ,'active': 'button_mid_bbox_draw'
                   ,'input': 'button_clicked'
                   ,'input_detail': 'draw_mid_bbox'
                   ,'mouse_position_x': ''
                   ,'mouse_position_y': ''
                   ,'rot_x': ''
                   ,'rot_y': ''
    ...
    def reset(self) -> None:
        super().reset()
        self.tmp_p1 = None
        self.view.button_pick_bbox_mid.setChecked(False)