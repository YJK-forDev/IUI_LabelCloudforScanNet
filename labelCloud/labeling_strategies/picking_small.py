...
class PickingStrategy_small(BaseLabelingStrategy):
    POINTS_NEEDED = 1
    PREVIEW = True
    ...
    def __init__(self, view: "GUI") -> None:
        ...
        self.copied_length: float = 0.3
        self.copied_width: float = 0.3
        self.copied_height: float = 0.3
        ...
        if self.tmp_p1:
            ...
            if True:
                ...
                new_row = {'index': ''
                           ...
                           ,'active': 'button_small_bbox_preview'
                           ,'input': 'button_clicked'
                           ,'input_detail': 'button_small_bbox'
                           ,'mouse_position_x': ''
                           ,'mouse_position_y': ''
                           ,'rot_x': ''
                           ,'rot_y': ''
    ...
    def get_bbox(self) -> BBox:  # TODO: Refactor
        ...
        new_row = {'index': ''
                   ...
                   ,'pcd': ''
                   ,'time':datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')
                   ,'active': 'button_small_bbox_draw'
                   ,'input': 'button_clicked'
                   ,'input_detail': 'draw_small_bbox'
                   ,'mouse_position_x': ''
                   ,'mouse_position_y': ''
                   ,'rot_x': ''
                   ,'rot_y': ''
    ...
    def reset(self) -> None:
        super().reset()
        self.tmp_p1 = None
        self.view.button_pick_bbox_small.setChecked(False)